::SET MAP=maps/maze/maze_04p_01.map
...
SET MAP=maps/maze/maze_p04_27.map


:: replace java -jar ../java/MyBot.jar with your own bot.
.\playgame.py --cutoff_turn 1000 --nolaunch --verbose -SoEeR --player_seed 42 --end_wait=0.25 --verbose --log_dir game_logs --turns 1000 --map_file %MAP% ^
    "python sample_bots/python/HunterBot.py" ^
    "python sample_bots/python/GreedyBot.py" ^
    "python sample_bots/python/LeftyBot.py" ^
	"java -jar ../java/MyBot.jar" | ^
